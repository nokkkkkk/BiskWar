...
namespace objects_in_scene
{
  ...
  void Spec_bloc::setup(bool p_block_depart)
  {
    m_bloc_angle = 0;
  ...
  bool Spec_bloc::get_bloc_lock() const
  {
    return m_block_lock;
  }

  void Spec_bloc::rotate_obj(int which, float angle, float rot_x, float rot_y, float r_z)
  {
    m_bloc_angle += angle;
